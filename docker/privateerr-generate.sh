...
#
# Write a timestamped env file that downstream projects can source or pass to Compose.
#
...
# Licensed under the Apache License, Version 2.0.
#
# Generated by Privateerr on $(date -u '+%Y-%m-%d %H:%M:%S UTC'). Do not edit manually.
#
